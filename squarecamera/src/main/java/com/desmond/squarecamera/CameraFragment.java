...
//                    Log.d(TAG, "cover height " + topCoverView.getHeight());
        ...
        final ImageView openGallery = (ImageView) view.findViewById(R.id.open_gallery);
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
    ...
    public void onGallerySelected()
    {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(R.id.fragment_container, Fragment.instantiate(getActivity(), MultiImageSelectorFragment.class.getName(), bundle))
                .addToBackStack(null)
                .commit();
    }
